...
export function StellarWalletProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    const instance = new StellarWalletsKit({
      // Always provide a passphrase (mapped from NEXT_PUBLIC_STELLAR_NETWORK
      // when needed) to satisfy all Wallets Kit versions.
      network: STELLAR_WALLET_NETWORK as any,
