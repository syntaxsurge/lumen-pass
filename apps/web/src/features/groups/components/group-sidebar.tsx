      ...
      <div className='space-y-3'>
        ...
        <div className='group relative flex items-center gap-2 rounded-lg border border-border/50 bg-muted/30 p-3 transition-colors hover:bg-muted/50'>
          ...
          <button
            ...
            className='flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-md bg-primary/10 text-primary transition-all hover:scale-105 hover:bg-primary/20 active:scale-95'
            title='Copy link'
          >
            {copied ? (
        ...
        <div className='space-y-3'>
          ...
          <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
            <DialogTrigger asChild>
              <Button
                className='w-full bg-destructive uppercase text-destructive-foreground hover:bg-destructive/80'
                variant='destructive'
                disabled={isDeleting}
              >
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  ...
                  classroom content, posts, and stored media. This cannot be
                  undone.
                </DialogDescription>
              </DialogHeader>
              <DialogFooter>
