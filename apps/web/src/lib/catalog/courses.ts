...
const catalog: CourseCatalogItem[] = [
  {
    ...
    tags: ['Solidity', 'Stellar', 'Tooling'],
    summary:
      'Hands-on introduction to Soroban smart contracts with Rust, the Stellar CLI toolchain, and secure deployment patterns for Stellar builders.'
  },
  {
    courseId: 2n,
    ...
    summary:
      'Blueprint and templates for crafting recurring-revenue membership products with LumenPass infrastructure on Stellar.'
  },
  {
    courseId: 3n,
