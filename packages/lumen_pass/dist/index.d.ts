...
export interface Client {
     ...
     */
    init: ({ creator, token, price, duration_ledgers, platform, fee_bps }: {
        creator: string;
        token: string;
        price: i128;
        duration_ledgers: u32;
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        subscribe: (json: string) => AssembledTransaction<number>;
        is_member: (json: string) => AssembledTransaction<boolean>;
        expires_at: (json: string) => AssembledTransaction<Option<number>>;
