...
export type DataKey = {tag: "Owner", values: void} | {tag: "Entry", values: readonly [string]};
...
export interface Client {
   ...
   */
  set: ({name, contract_id}: {name: string, contract_id: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  remove: ({name}: {name: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  resolve: ({name}: {name: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAgAAAAAAAAAAAAAAB0RhdGFLZXkAAAAAAgAAAAAAAAAAAAAABU93bmVyAAAAAAAAAQAAAAAAAAAFRW50cnkAAAAAAAABAAAAEA==",
        ...
        "AAAAAAAAAAAAAAAHcmVzb2x2ZQAAAAABAAAAAAAAAARuYW1lAAAAEAAAAAEAAAPoAAAAEw==" ]),
      options
    )
  }
  public readonly fromJSON = {
    init: this.txFromJSON<null>,
        ...
        remove: this.txFromJSON<null>,
        resolve: this.txFromJSON<Option<string>>
  }
}